/// Forked from <https://github.com/flutter/flutter/blob/master/packages/flutter_driver/lib/src/native/goldens.dart>.
library;
...
final class _MatchesGoldenFile extends AsyncMatcher {
  ...
  Future<String?> matchAsync(Object? item) async {
    ...
    } else if (item is io.File) {
      buffer = await item.readAsBytes();
    } else {
      throw ArgumentError(
